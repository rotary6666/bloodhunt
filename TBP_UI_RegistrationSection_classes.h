...
struct UTBP_UI_RegistrationSection_C : UUserWidget {
	...
	void UsernameNotInPassword(bool& OutError); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.UsernameNotInPassword // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void GetCountryShouldShowExportGate(bool& OutShouldShowExportGate); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.GetCountryShouldShowExportGate // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	struct FEventReply OnKeyDown(struct FGeometry MyGeometry, struct FKeyEvent InKeyEvent); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.OnKeyDown // (BlueprintCosmetic|Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void CheckAgeRestrictionDirectlyByYearSelection(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.CheckAgeRestrictionDirectlyByYearSelection // (Public|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void GetCountryRegionId(int32_t& OutRegionId); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.GetCountryRegionId // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void ValidatePasswordEntry(bool& OutCorrectlyEntered); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.ValidatePasswordEntry // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void CheckRegistrationFormReady(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.CheckRegistrationFormReady // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void VerifyDateOfBirth(bool& bValid, struct FText& Message); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.VerifyDateOfBirth // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void GetEnteredDateOfBirth(bool& IsValidDate, struct FDateTime& DateOfBirth); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.GetEnteredDateOfBirth // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x18b4070
	void MakeArray(int32_t FirstIndex, int32_t LastIndex, bool InvertList, struct TArray<struct FText>& NewParam); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.MakeArray // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void Verify(struct FText& Error); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.Verify // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	struct FString GetEnteredEmail(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.GetEnteredEmail // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x18b4070
	void PopulateComboBox(struct UComboBoxString* InComboBox, int32_t FirstOption, int32_t LastOption, bool Reverse); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.PopulateComboBox // (Public|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void GetEnteredDetails(struct FString Verification Code, struct FSharkAccountRegistrationData& Registration Data); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.GetEnteredDetails // (Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure) // @ game+0x18b4070
	void OnFailure_97305E0F48D8BC638754BE97B048207B(bool bEmailAvailable, struct FString ErrorMessage); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.OnFailure_97305E0F48D8BC638754BE97B048207B // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void OnSuccess_97305E0F48D8BC638754BE97B048207B(bool bEmailAvailable, struct FString ErrorMessage); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.OnSuccess_97305E0F48D8BC638754BE97B048207B // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void OnFailure_47FEBBC041B668BCB406448A43821565(bool bUserNameAvailable, bool bUserNameContainsProfanity, struct FString ErrorString); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.OnFailure_47FEBBC041B668BCB406448A43821565 // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void OnSuccess_47FEBBC041B668BCB406448A43821565(bool bUserNameAvailable, bool bUserNameContainsProfanity, struct FString ErrorString); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.OnSuccess_47FEBBC041B668BCB406448A43821565 // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void OnFailure_FE7265334A5769C9FEF0CCB5E78C58E0(bool bUserNameAvailable, bool bUserNameContainsProfanity, struct FString ErrorString); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.OnFailure_FE7265334A5769C9FEF0CCB5E78C58E0 // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void OnSuccess_FE7265334A5769C9FEF0CCB5E78C58E0(bool bUserNameAvailable, bool bUserNameContainsProfanity, struct FString ErrorString); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.OnSuccess_FE7265334A5769C9FEF0CCB5E78C58E0 // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void OnFailure_08A67A8E428B9588EDCCE9BE9CC66E26(bool bEmailAvailable, struct FString ErrorMessage); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.OnFailure_08A67A8E428B9588EDCCE9BE9CC66E26 // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void OnSuccess_08A67A8E428B9588EDCCE9BE9CC66E26(bool bEmailAvailable, struct FString ErrorMessage); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.OnSuccess_08A67A8E428B9588EDCCE9BE9CC66E26 // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void Construct(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.Construct // (BlueprintCosmetic|Event|Public|BlueprintEvent) // @ game+0x18b4070
	void BndEvt__Button_CTA_RegisterButton_K2Node_ComponentBoundEvent_1_OnClicked__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__Button_CTA_RegisterButton_K2Node_ComponentBoundEvent_1_OnClicked__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	void BndEvt__UsernameBox_K2Node_ComponentBoundEvent_0_On Text Settled__DelegateSignature(struct FText Text); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__UsernameBox_K2Node_ComponentBoundEvent_0_On Text Settled__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	void BndEvt__EmailBox_K2Node_ComponentBoundEvent_2_On Text Settled__DelegateSignature(struct FText Text); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__EmailBox_K2Node_ComponentBoundEvent_2_On Text Settled__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	void BndEvt__PasswordBox_K2Node_ComponentBoundEvent_3_On Text Settled__DelegateSignature(struct FText Text); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__PasswordBox_K2Node_ComponentBoundEvent_3_On Text Settled__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	void BndEvt__RepeatPasswordBox_K2Node_ComponentBoundEvent_5_On Text Settled__DelegateSignature(struct FText Text); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__RepeatPasswordBox_K2Node_ComponentBoundEvent_5_On Text Settled__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	void BndEvt__TBP_UI_TextButton_Back_K2Node_ComponentBoundEvent_6_OnClicked__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__TBP_UI_TextButton_Back_K2Node_ComponentBoundEvent_6_OnClicked__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	...
	void UsernameAvailabilityCallback(bool InAvailable, struct FText InErrorText, bool InProfanity); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.UsernameAvailabilityCallback // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void EmailAvailabilityCallback(bool InAvailable, struct FText InErrorText); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.EmailAvailabilityCallback // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	...
	void BndEvt__EmailBox_K2Node_ComponentBoundEvent_11_On Text Changed__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__EmailBox_K2Node_ComponentBoundEvent_11_On Text Changed__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	void BndEvt__UsernameBox_K2Node_ComponentBoundEvent_12_On Text Changed__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__UsernameBox_K2Node_ComponentBoundEvent_12_On Text Changed__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	void StartEmailTimeOutTimer(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.StartEmailTimeOutTimer // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void StopEmailTimeOutTimer(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.StopEmailTimeOutTimer // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void Timeout(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.Timeout // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void ShowTermsOfService(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.ShowTermsOfService // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void ShowPrivacyPolicy(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.ShowPrivacyPolicy // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	...
	void DoubleCheckPasswordAfterUpdatedUsername(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.DoubleCheckPasswordAfterUpdatedUsername // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void CheckIfShouldDoubleCheckPasswordField(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.CheckIfShouldDoubleCheckPasswordField // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	...
	void BndEvt__TBP_UI_RegistrationSection_KoreaCheckbox1_K2Node_ComponentBoundEvent_14_OnChecked_false__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__TBP_UI_RegistrationSection_KoreaCheckbox1_K2Node_ComponentBoundEvent_14_OnChecked_false__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	...
	void BndEvt__TBP_UI_RegistrationSection_KoreaCheckbox4_K2Node_ComponentBoundEvent_22_OnChecked_true__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__TBP_UI_RegistrationSection_KoreaCheckbox4_K2Node_ComponentBoundEvent_22_OnChecked_true__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	...
	void ShowNewsletterAgreement(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.ShowNewsletterAgreement // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void ExitDueToTimeOut(bool InAvailable, struct FText InErrorText); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.ExitDueToTimeOut // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	...
	void BndEvt__TBP_UI_RegistrationSection_KoreaCheckbox2_K2Node_ComponentBoundEvent_26_OnClickedPopupRequirement__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.BndEvt__TBP_UI_RegistrationSection_KoreaCheckbox2_K2Node_ComponentBoundEvent_26_OnClickedPopupRequirement__DelegateSignature // (BlueprintEvent) // @ game+0x18b4070
	...
	void ResetAllCheckBoxes(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.ResetAllCheckBoxes // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void QueryUsernameRegisterCallback(bool bInSuccess, bool bIsAvailable, bool bIsProfanity, struct FString InUsername); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.QueryUsernameRegisterCallback // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void StopUsernameTimeoutTimer(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.StopUsernameTimeoutTimer // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void StartUsernameTimeOutTimer(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.StartUsernameTimeOutTimer // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void UsernameTimeout(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.UsernameTimeout // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void UsernameExitDueToTimeout(bool bInAvailable, struct FText InErrorText); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.UsernameExitDueToTimeout // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void GetLegalTexts(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.GetLegalTexts // (BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void ExecuteUbergraph_TBP_UI_RegistrationSection(int32_t EntryPoint); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.ExecuteUbergraph_TBP_UI_RegistrationSection // (Final|UbergraphFunction|HasDefaults) // @ game+0x18b4070
	void ExitGame__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.ExitGame__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void Back__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.Back__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
	void CreateAccount__DelegateSignature(); // Function TBP_UI_RegistrationSection.TBP_UI_RegistrationSection_C.CreateAccount__DelegateSignature // (Public|Delegate|BlueprintCallable|BlueprintEvent) // @ game+0x18b4070
};
