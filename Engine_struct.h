...
enum class EActorStreamingPriorityTiers : uint8 {
	PriorityNone = 0,
	PriorityHighest = 50,
	PriorityHigh = 100,
	PriorityMedium = 150,
	...
	PriorityLower = 215,
	PriorityLowest = 255,
	EActorStreamingPriorityTiers_MAX = 256
};
...
enum class EShadowDetailMode : uint8 {
	SDM_Low = 0,
	SDM_Medium = 1,
	SDM_High = 2,
	SDM_MAX = 3
...
enum class EConditionalTextureComparisonOperator : uint8 {
	GreaterThan = 0,
	...
	Equal = 4,
	NotEqual = 5,
	EConditionalTextureComparisonOperator_MAX = 6
};
...
enum class EParticleResolutionMode : uint8 {
	Full = 0,
	Quarter = 1,
	Sixteenth = 2,
...
enum class EStaticMeshTranslucencyResolutionMode : uint8 {
	Full = 0,
	Quarter = 1,
	Sixteenth = 2,
...
struct FClusteredStaticMeshEntry {
	...
	struct UClusteredStaticMeshComponent* Owner; // 0x50(0x08)
	char CastShadow : 1; // 0x58(0x01)
	char bAffectDynamicIndirectLighting : 1; // 0x58(0x01)
	char bAffectDistanceFieldLighting : 1; // 0x58(0x01)
	char bCastDynamicShadow : 1; // 0x58(0x01)
	char bCastStaticShadow : 1; // 0x58(0x01)
	char bCastVolumetricTranslucentShadow : 1; // 0x58(0x01)
	char bCastContactShadow : 1; // 0x58(0x01)
	char bSelfShadowOnly : 1; // 0x58(0x01)
	char bCastFarShadow : 1; // 0x59(0x01)
	char bCastInsetShadow : 1; // 0x59(0x01)
	char bCastCinematicShadow : 1; // 0x59(0x01)
	char bCastHiddenShadow : 1; // 0x59(0x01)
	char bCastShadowAsTwoSided : 1; // 0x59(0x01)
	char pad_59_5 : 3; // 0x59(0x01)
	bool bReverseCulling; // 0x5a(0x01)
	bool bOverrideDistanceFieldSelfShadowBias; // 0x5b(0x01)
	float DistanceFieldIndirectShadowMinVisibility; // 0x5c(0x04)
	float DistanceFieldSelfShadowBias; // 0x60(0x04)
	float LpvBiasMultiplier; // 0x64(0x04)
	struct FCustomPrimitiveData CustomPrimitiveData; // 0x68(0x10)
	int32_t SortPriority; // 0x78(0x04)
	enum class ELightmapType LightmapType; // 0x7c(0x01)
	char pad_7D[0x3]; // 0x7d(0x03)
	int32_t MinLOD; // 0x80(0x04)
	char bOverrideMinLOD : 1; // 0x84(0x01)
	char bReceivesDecals : 1; // 0x84(0x01)
	char bOnlyOwnerSee : 1; // 0x84(0x01)
	char bOwnerNoSee : 1; // 0x84(0x01)
	char bHasMotionBlurVelocityMeshes : 1; // 0x84(0x01)
	char bVisibleInReflectionCaptures : 1; // 0x84(0x01)
	char bVisibleInRealTimeSkyCaptures : 1; // 0x84(0x01)
	char bVisibleInRayTracing : 1; // 0x84(0x01)
	char bRenderInMainPass : 1; // 0x85(0x01)
	char bRenderInDepthPass : 1; // 0x85(0x01)
	char bTreatAsBackgroundForOcclusion : 1; // 0x85(0x01)
	char bUseAsOccluder : 1; // 0x85(0x01)
	char bOnlyRenderDepth : 1; // 0x85(0x01)
	char bHasValidSettingsForStaticLighting : 1; // 0x85(0x01)
	char pad_85_6 : 2; // 0x85(0x01)
	enum class ESceneDepthPriorityGroup DepthPriorityGroup; // 0x86(0x01)
	enum class ESceneDepthPriorityGroup ViewOwnerDepthPriorityGroup; // 0x87(0x01)
	struct FLightmassPrimitiveSettings LightmassSettings; // 0x88(0x18)
	int32_t LODDataIndex; // 0xa0(0x04)
	enum class EShadowDetailMode ShadowDetailMode; // 0xa4(0x01)
	char bLightAttachmentsAsGroup : 1; // 0xa5(0x01)
	char bSingleSampleShadowFromStationaryLights : 1; // 0xa5(0x01)
	char bReceiveMobileCSMShadows : 1; // 0xa5(0x01)
	char bRenderCustomDepth : 1; // 0xa5(0x01)
	char bCullCustomDepth : 1; // 0xa5(0x01)
	char pad_A5_5 : 3; // 0xa5(0x01)
	enum class ERendererStencilMask CustomDepthStencilWriteMask; // 0xa6(0x01)
	char pad_A7[0x1]; // 0xa7(0x01)
	int32_t CustomDepthStencilValue; // 0xa8(0x04)
	struct FLightingChannels LightingChannels; // 0xac(0x01)
	enum class EIndirectLightingCacheQuality IndirectLightingCacheQuality; // 0xad(0x01)
	int8_t VirtualTextureLodBias; // 0xae(0x01)
	int8_t VirtualTextureCullMips; // 0xaf(0x01)
	int8_t VirtualTextureMinCoverage; // 0xb0(0x01)
	char pad_B1[0x3]; // 0xb1(0x03)
	float MinDrawDistance; // 0xb4(0x04)
	float LDMaxDrawDistance; // 0xb8(0x04)
	float CachedMaxDrawDistance; // 0xbc(0x04)
	float ScreenCullSizeOverride; // 0xc0(0x04)
	float CachedScreenCullSize; // 0xc4(0x04)
	struct TArray<struct URuntimeVirtualTexture*> RuntimeVirtualTextures; // 0xc8(0x10)
	enum class ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType; // 0xd8(0x01)
	char pad_D9[0x3]; // 0xd9(0x03)
	float VirtualTextureMainPassMaxDrawDistance; // 0xdc(0x04)
	struct FBoxSphereBounds Bounds; // 0xe0(0x1c)
	struct FBoxSphereBounds LocalBounds; // 0xfc(0x1c)
...
struct FMeshProxySettings {
	...
	char bAllowAdjacency : 1; // 0xa7(0x01)
...
struct FNavDataConfig : FNavAgentProperties {
	...
	bool bClientRelevant; // 0x50(0x01)
	bool bDedicatedServerRelevant; // 0x51(0x01)
	bool bListenServerRelevant; // 0x52(0x01)
	bool bStandaloneRelevant; // 0x53(0x01)
	char pad_54[0x4]; // 0x54(0x04)
...
struct FMeshSectionInfo {
	...
	enum class EStaticMeshTranslucencyResolutionMode TranslucencyResolution; // 0x04(0x01)
	bool bEnableCollision; // 0x05(0x01)
	bool bCastShadow; // 0x06(0x01)
	bool bVisibleInRayTracing; // 0x07(0x01)
	bool bForceOpaque; // 0x08(0x01)
	bool bIsVisible; // 0x09(0x01)
	char pad_A[0x2]; // 0x0a(0x02)
};
...
struct FStaticMeshSourceModel {
	...
	bool bUseLod0Lightmap; // 0x70(0x01)
	char pad_71[0x7]; // 0x71(0x07)
};
