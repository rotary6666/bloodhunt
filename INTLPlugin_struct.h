...
struct FINTLDirTreeNode {
	...
	int32_t ParentId; // 0x04(0x04)
	bool IsLeaf; // 0x08(0x01)
	char pad_9[0x7]; // 0x09(0x07)
	struct FString Name; // 0x10(0x10)
	struct FString URL; // 0x20(0x10)
	int32_t Status; // 0x30(0x04)
	int32_t Tag; // 0x34(0x04)
	int32_t CustomInt1; // 0x38(0x04)
	int32_t CustomInt2; // 0x3c(0x04)
...
struct FINTLAccountResult : FINTLBaseResult {
	...
	int32_t ExpireTime; // 0x98(0x04)
	int32_t IsRegister; // 0x9c(0x04)
	int32_t IsSetPassword; // 0xa0(0x04)
	int32_t IsReceiveEmail; // 0xa4(0x04)
	int32_t VerifyCodeExpireTime; // 0xa8(0x04)
	int32_t CanBind; // 0xac(0x04)
	struct FString PpAcceptanceVersion; // 0xb0(0x10)
	struct FString TosAcceptanceVersion; // 0xc0(0x10)
	struct FDateTime PpAcceptanceTime; // 0xd0(0x08)
	struct FDateTime TosAcceptanceTime; // 0xd8(0x08)
	struct FINTLAccountProfile Profile; // 0xe0(0xd8)
	int32_t IsUserNameAvailable; // 0x1b8(0x04)
...
struct FINTLAccountProfile {
	...
	int32_t AccountType; // 0x90(0x04)
	char pad_94[0x4]; // 0x94(0x04)
	struct FString NickName; // 0x98(0x10)
	struct FString PrivacyPolicy; // 0xa8(0x10)
	struct FString TermsOfService; // 0xb8(0x10)
	int32_t PrivacyUpdateTime; // 0xc8(0x04)
	int32_t TermsUpdateTime; // 0xcc(0x04)
	int32_t UsernamePassVerify; // 0xd0(0x04)
...
struct FINTLAuthResult : FINTLBaseResult {
	...
	int32_t DeleteAccountStatus; // 0x128(0x04)
