...
struct ANavigationData : AActor {
	...
	char pad_2C8[0x108]; // 0x2c8(0x108)
	struct TArray<struct FSupportedAreaData> SupportedAreas; // 0x3d0(0x10)
...
struct UNavigationPath : UObject {
	...
	bool IsValid(); // Function NavigationSystem.NavigationPath.IsValid // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x34d6df0
	bool IsStringPulled(); // Function NavigationSystem.NavigationPath.IsStringPulled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x14e1990
	bool IsPartial(); // Function NavigationSystem.NavigationPath.IsPartial // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x34d6dc0
	float GetPathLength(); // Function NavigationSystem.NavigationPath.GetPathLength // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x34d6680
	float GetPathCost(); // Function NavigationSystem.NavigationPath.GetPathCost // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x34d6420
	struct FString GetDebugString(); // Function NavigationSystem.NavigationPath.GetDebugString // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0x34d6310
	void EnableRecalculationOnInvalidation(enum class ENavigationOptionFlag DoRecalculation); // Function NavigationSystem.NavigationPath.EnableRecalculationOnInvalidation // (Final|Native|Public|BlueprintCallable) // @ game+0x34d5eb0
	void EnableDebugDrawing(bool bShouldDrawDebugData, struct FLinearColor PathColor); // Function NavigationSystem.NavigationPath.EnableDebugDrawing // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x34d5dd0
};
...
struct UNavigationSystemV1 : UNavigationSystemBase {
	...
	struct FName DefaultAgentName; // 0x3c(0x08)
	...
	char bGenerateNavigationOnlyAroundNavigationInvokers : 1; // 0x71(0x01)
	char pad_71_2 : 6; // 0x71(0x01)
	char pad_72[0x2]; // 0x72(0x02)
	float ActiveTilesUpdateInterval; // 0x74(0x04)
	enum class ENavDataGatheringModeConfig DataGatheringMode; // 0x78(0x01)
	char pad_79[0x3]; // 0x79(0x03)
	float DirtyAreaWarningSizeThreshold; // 0x7c(0x04)
	...
	char pad_1C5[0x143f]; // 0x1c5(0x143f)
	float DirtyAreasUpdateFreq; // 0x1604(0x04)
	char pad_1608[0x20]; // 0x1608(0x20)

	void UnregisterNavigationInvoker(struct AActor* Invoker); // Function NavigationSystem.NavigationSystemV1.UnregisterNavigationInvoker // (Final|Native|Public|BlueprintCallable) // @ game+0x34d7de0
	void SimpleMoveToLocation(struct AController* Controller, struct FVector& Goal); // Function NavigationSystem.NavigationSystemV1.SimpleMoveToLocation // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x34d7d20
	void SimpleMoveToActor(struct AController* Controller, struct AActor* Goal); // Function NavigationSystem.NavigationSystemV1.SimpleMoveToActor // (Final|Native|Static|Public|BlueprintCallable) // @ game+0x34d7c60
	void SetMaxSimultaneousTileGenerationJobsCount(int32_t MaxNumberOfJobs); // Function NavigationSystem.NavigationSystemV1.SetMaxSimultaneousTileGenerationJobsCount // (Final|Native|Public|BlueprintCallable) // @ game+0x34d7bd0
	void SetGeometryGatheringMode(enum class ENavDataGatheringModeConfig NewMode); // Function NavigationSystem.NavigationSystemV1.SetGeometryGatheringMode // (Final|Native|Public|BlueprintCallable) // @ game+0x34d7b50
	void ResetMaxSimultaneousTileGenerationJobsCount(); // Function NavigationSystem.NavigationSystemV1.ResetMaxSimultaneousTileGenerationJobsCount // (Final|Native|Public|BlueprintCallable) // @ game+0x34d7b30
	void RegisterNavigationInvoker(struct AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius); // Function NavigationSystem.NavigationSystemV1.RegisterNavigationInvoker // (Final|Native|Public|BlueprintCallable) // @ game+0x34d7a20
	struct FVector ProjectPointToNavigation(struct UObject* WorldContextObject, struct FVector& Point, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass, struct FVector QueryExtent); // Function NavigationSystem.NavigationSystemV1.ProjectPointToNavigation // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x34d7830
	void OnNavigationBoundsUpdated(struct ANavMeshBoundsVolume* NavVolume); // Function NavigationSystem.NavigationSystemV1.OnNavigationBoundsUpdated // (Final|Native|Public|BlueprintCallable) // @ game+0x34d77a0
	bool NavigationRaycast(struct UObject* WorldContextObject, struct FVector& RayStart, struct FVector& RayEnd, struct FVector& HitLocation, struct UNavigationQueryFilter* FilterClass, struct AController* Querier); // Function NavigationSystem.NavigationSystemV1.NavigationRaycast // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x34d7570
	bool K2_ReplaceAreaInOctreeData(struct UObject* Object, struct UNavArea* OldArea, struct UNavArea* NewArea); // Function NavigationSystem.NavigationSystemV1.K2_ReplaceAreaInOctreeData // (Final|Native|Public|BlueprintCallable) // @ game+0x34d7460
	bool K2_ProjectPointToNavigation(struct UObject* WorldContextObject, struct FVector& Point, struct FVector& ProjectedLocation, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass, struct FVector QueryExtent); // Function NavigationSystem.NavigationSystemV1.K2_ProjectPointToNavigation // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x34d7260
	bool K2_GetRandomReachablePointInRadius(struct UObject* WorldContextObject, struct FVector& Origin, struct FVector& RandomLocation, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.K2_GetRandomReachablePointInRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x34d7040
	bool K2_GetRandomPointInNavigableRadius(struct UObject* WorldContextObject, struct FVector& Origin, struct FVector& RandomLocation, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.K2_GetRandomPointInNavigableRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x34d6e20
	bool K2_GetRandomLocationInNavigableRadius(struct UObject* WorldContextObject, struct FVector& Origin, struct FVector& RandomLocation, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.K2_GetRandomLocationInNavigableRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x34d6e20
	bool IsNavigationBeingBuiltOrLocked(struct UObject* WorldContextObject); // Function NavigationSystem.NavigationSystemV1.IsNavigationBeingBuiltOrLocked // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x34d6d30
	bool IsNavigationBeingBuilt(struct UObject* WorldContextObject); // Function NavigationSystem.NavigationSystemV1.IsNavigationBeingBuilt // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x34d6ca0
	struct FVector GetRandomReachablePointInRadius(struct UObject* WorldContextObject, struct FVector& Origin, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetRandomReachablePointInRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x34d6ac0
	struct FVector GetRandomPointInNavigableRadius(struct UObject* WorldContextObject, struct FVector& Origin, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetRandomPointInNavigableRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x34d68e0
	enum class ENavigationQueryResult GetPathLength(struct UObject* WorldContextObject, struct FVector& PathStart, struct FVector& PathEnd, float& PathLength, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetPathLength // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x34d66b0
	enum class ENavigationQueryResult GetPathCost(struct UObject* WorldContextObject, struct FVector& PathStart, struct FVector& PathEnd, float& PathCost, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetPathCost // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0x34d6450
	struct UNavigationSystemV1* GetNavigationSystem(struct UObject* WorldContextObject); // Function NavigationSystem.NavigationSystemV1.GetNavigationSystem // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0x34d6390
	struct UNavigationPath* FindPathToLocationSynchronously(struct UObject* WorldContextObject, struct FVector& PathStart, struct FVector& PathEnd, struct AActor* PathfindingContext, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.FindPathToLocationSynchronously // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x34d6140
	struct UNavigationPath* FindPathToActorSynchronously(struct UObject* WorldContextObject, struct FVector& PathStart, struct AActor* GoalActor, float TetherDistance, struct AActor* PathfindingContext, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.FindPathToActorSynchronously // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0x34d5f30
};
...
struct UNavRelevantComponent : UActorComponent {
	...
	void SetNavigationRelevancy(bool bRelevant); // Function NavigationSystem.NavRelevantComponent.SetNavigationRelevancy // (Final|Native|Public|BlueprintCallable) // @ game+0x34d9de0
};
...
struct UNavModifierComponent : UNavRelevantComponent {
	...
	void SetAreaClass(struct UNavArea* NewAreaClass); // Function NavigationSystem.NavModifierComponent.SetAreaClass // (Final|Native|Public|BlueprintCallable) // @ game+0x34d9d50
};
...
struct ANavModifierVolume : AVolume {
	...
	bool bMaskFillCollisionUnderneathForNavmesh; // 0x270(0x01)
	char pad_271[0x7]; // 0x271(0x07)

	void SetAreaClass(struct UNavArea* NewAreaClass); // Function NavigationSystem.NavModifierVolume.SetAreaClass // (Final|Native|Public|BlueprintCallable) // @ game+0x34d9cc0
};
...
// Size: 0x4e8 (Inherited: 0x438)
struct ARecastNavMesh : ANavigationData {
	char bDrawTriangleEdges : 1; // 0x438(0x01)
	char bDrawPolyEdges : 1; // 0x438(0x01)
	char bDrawFilledPolys : 1; // 0x438(0x01)
	char bDrawNavMeshEdges : 1; // 0x438(0x01)
	char bDrawTileBounds : 1; // 0x438(0x01)
	char bDrawPathCollidingGeometry : 1; // 0x438(0x01)
	char bDrawTileLabels : 1; // 0x438(0x01)
	char bDrawPolygonLabels : 1; // 0x438(0x01)
	char bDrawDefaultPolygonCost : 1; // 0x439(0x01)
	char bDrawLabelsOnPathNodes : 1; // 0x439(0x01)
	char bDrawNavLinks : 1; // 0x439(0x01)
	char bDrawFailedNavLinks : 1; // 0x439(0x01)
	char bDrawClusters : 1; // 0x439(0x01)
	char bDrawOctree : 1; // 0x439(0x01)
	char bDrawOctreeDetails : 1; // 0x439(0x01)
	char bDrawMarkedForbiddenPolys : 1; // 0x439(0x01)
	char bDistinctlyDrawTilesBeingBuilt : 1; // 0x43a(0x01)
	char pad_43A_1 : 7; // 0x43a(0x01)
	char pad_43B[0x1]; // 0x43b(0x01)
	float DrawOffset; // 0x43c(0x04)
	char bFixedTilePoolSize : 1; // 0x440(0x01)
	char pad_440_1 : 7; // 0x440(0x01)
	char pad_441[0x3]; // 0x441(0x03)
	int32_t TilePoolSize; // 0x444(0x04)
	float TileSizeUU; // 0x448(0x04)
	float CellSize; // 0x44c(0x04)
	float CellHeight; // 0x450(0x04)
	float AgentRadius; // 0x454(0x04)
	float AgentHeight; // 0x458(0x04)
	float AgentMaxSlope; // 0x45c(0x04)
	float AgentMaxStepHeight; // 0x460(0x04)
	float MinRegionArea; // 0x464(0x04)
	float MergeRegionSize; // 0x468(0x04)
	float MaxSimplificationError; // 0x46c(0x04)
	int32_t MaxSimultaneousTileGenerationJobsCount; // 0x470(0x04)
	int32_t TileNumberHardLimit; // 0x474(0x04)
	int32_t PolyRefTileBits; // 0x478(0x04)
	int32_t PolyRefNavPolyBits; // 0x47c(0x04)
	int32_t PolyRefSaltBits; // 0x480(0x04)
	struct FVector NavMeshOriginOffset; // 0x484(0x0c)
	float DefaultDrawDistance; // 0x490(0x04)
	float DefaultMaxSearchNodes; // 0x494(0x04)
	float DefaultMaxHierarchicalSearchNodes; // 0x498(0x04)
	enum class ERecastPartitioning RegionPartitioning; // 0x49c(0x01)
	enum class ERecastPartitioning LayerPartitioning; // 0x49d(0x01)
	char pad_49E[0x2]; // 0x49e(0x02)
	int32_t RegionChunkSplits; // 0x4a0(0x04)
	int32_t LayerChunkSplits; // 0x4a4(0x04)
	char bSortNavigationAreasByCost : 1; // 0x4a8(0x01)
	char bPerformVoxelFiltering : 1; // 0x4a8(0x01)
	char bMarkLowHeightAreas : 1; // 0x4a8(0x01)
	char bUseExtraTopCellWhenMarkingAreas : 1; // 0x4a8(0x01)
	char bFilterLowSpanSequences : 1; // 0x4a8(0x01)
	char bFilterLowSpanFromTileCache : 1; // 0x4a8(0x01)
	char bDoFullyAsyncNavDataGathering : 1; // 0x4a8(0x01)
	char bUseBetterOffsetsFromCorners : 1; // 0x4a8(0x01)
	char bStoreEmptyTileLayers : 1; // 0x4a9(0x01)
	char bUseVirtualFilters : 1; // 0x4a9(0x01)
	char bAllowNavLinkAsPathEnd : 1; // 0x4a9(0x01)
	char bUseVoxelCache : 1; // 0x4a9(0x01)
	char pad_4A9_4 : 4; // 0x4a9(0x01)
	char pad_4AA[0x2]; // 0x4aa(0x02)
	float TileSetUpdateInterval; // 0x4ac(0x04)
	float HeuristicScale; // 0x4b0(0x04)
	float VerticalDeviationFromGroundCompensation; // 0x4b4(0x04)
	char pad_4B8[0x30]; // 0x4b8(0x30)

	bool K2_ReplaceAreaInTileBounds(struct FBox Bounds, struct UNavArea* OldArea, struct UNavArea* NewArea, bool ReplaceLinks); // Function NavigationSystem.RecastNavMesh.K2_ReplaceAreaInTileBounds // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0x34d9b20
};
