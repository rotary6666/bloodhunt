...
struct UGizmoBaseComponent : UPrimitiveComponent {
	...
	float HoverSizeMultiplier; // 0x460(0x04)
	float PixelHitDistanceThreshold; // 0x464(0x04)
	char pad_468[0x8]; // 0x468(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0x35d1fa0
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0x35d1f10
};

// Class InteractiveToolsFramework.GizmoArrowComponent
// Size: 0x490 (Inherited: 0x470)
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x470(0x0c)
	float Gap; // 0x47c(0x04)
	float Length; // 0x480(0x04)
	float Thickness; // 0x484(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x470(0x0c)
...
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x470(0x0c)
	float Radius; // 0x47c(0x04)
	float Thickness; // 0x480(0x04)
	int32_t NumSides; // 0x484(0x04)
	bool bViewAligned; // 0x488(0x01)
	bool bOnlyAllowFrontFacingHits; // 0x489(0x01)
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform& NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0x35d1e30
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0x35d1c70
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0x35d1ce0
	void GetTangentVectors(struct FVector& TangentXOut, struct FVector& TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0x35d1b80
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0x35d1ad0
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0x35d1a90
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0xbfffe0
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0x1501130
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0x1501050
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0x35d1d10
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0x35d1b10
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0x35d1a70
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0x1501130
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D& NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0x35d1da0
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0x35d1b40
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0x35d1a70
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0x1501130
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x470(0x0c)
	float HandleSize; // 0x47c(0x04)
	float Thickness; // 0x480(0x04)
	struct FVector Direction; // 0x484(0x0c)
	float Length; // 0x490(0x04)
	bool bImageScale; // 0x494(0x01)
...
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x470(0x0c)
	struct FVector DirectionY; // 0x47c(0x0c)
	float OffsetX; // 0x488(0x04)
	float OffsetY; // 0x48c(0x04)
	float LengthX; // 0x490(0x04)
	float LengthY; // 0x494(0x04)
	float Thickness; // 0x498(0x04)
	char SegmentFlags; // 0x49c(0x01)
